...
\end{lstlisting}
        ...
        \item En esta pantalla se presiona el botón \emph{ESCANEAR REDES} para el escaneo de las redes que se encuentran en nuestro alcance en un tiempo determinado.
