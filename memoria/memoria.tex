...
\begin{itemize}
	...
	\begingroup{}
	\fontsize{7pt}{7pt}=\selectfont
	\verbatiminput {SECWEP.py.txt}
	\endgroup{}
	
		\begin{itemize}
		\item SECWEP1-Template.tex
		
		\begingroup{}
		\fontsize{7pt}{7pt}=\selectfont
		\verbatiminput {SECWEP1-Template.tex.txt}
		\endgroup{}
	...
	Esta sección se utilizará tanto para el protocolo WEP como para el WPA/WPA2.
		...
		\begingroup{}
		\fontsize{7pt}{7pt}=\selectfont
		\verbatiminput {SUBSDOS.py.txt}
		\endgroup{}
	
		\begin{itemize}
		
		\item SUBSDOS-Template.tex
		
		\begingroup{}
		\fontsize{7pt}{7pt}=\selectfont
		\verbatiminput {SUBSDOS-Template.tex.txt}
		\endgroup{}
		
		\item INF-SUBSDOS.tex
		
		\begingroup{}
		\fontsize{7pt}{7pt}=\selectfont
		\verbatiminput {INF-SUBSDOS.tex.txt}
		\endgroup{}
		\end{itemize}
		
	\item SUBSWEP1.py	:
	Por ultimo, se obtendrá toda la información necesaria a la hora de generar el informe automatizado, tras un ataque a una red con cifrado WEP. Los pasos que se han seguido son exactamente los mismos que las secciones anteriores.
	
		\begingroup{}
		\fontsize{7pt}{7pt}=\selectfont
		\verbatiminput {SUBSWEP1.py.txt}
		\endgroup{}
		
		\begin{itemize}
		
		\item SUBSWEP1-Template.tex
		\begingroup{}
		\fontsize{7pt}{7pt}=\selectfont
		\verbatiminput {SUBSWEP1-Template.tex.txt}
		\endgroup{}
		
		
		\item INF-SUBSWEP1.tex
		\begingroup{}
		\fontsize{7pt}{7pt}=\selectfont
		\verbatiminput {INF-SUBSWEP1.tex.txt}
		\endgroup{}
...
Se utilizan los mismo programas y el mismo lenguaje de programación por lo que no se volverá a explicar de nuevo, pudiendo leerlo en el ANEXO D, si fuera necesario.
