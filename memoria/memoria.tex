...
%%%%ANTECEDENTES PYMES%%%%
\section{Antecedentes de seguridad informática en pequeñas y medianas empresas (PYMEs)}
...
%%%%%%%ANTECEDENTES WIFI%%%%
\section{Antecedentes de seguridad informática en redes WiFi}
...
\end{itemize}
En cuanto a la autenticación, \textit{Open system} deja a todos los clientes que se lo pidan, autenticarse al punto de acceso, mientras que \textit{Shared key} necesita un mensaje solicitando conexión previa. Este (punto de acceso) contesta con un paquete cifrado por el cliente y se reenvía al punto de acceso que intenta descifrar la autenticación para que sea válida.
...
Un pentesting de forma continua permite que los procesos de las auditorías de seguridad dispongan de las mismas posibilidades de conseguir privilegios, que una persona mal intencionada, aun así se debe seguir manteniendo la seguridad en todas las fases de gestión de la seguridad.\\
...
La suite de herramientas \textit{``air''} proporciona todo lo necesario para llevar a cabo auditorías a redes wireless. También disponemos de más herramientas, como son GUIs o \textit{sripts}, que por debajo utilizan las propias herramientas de la suite. 
...
Probe & Paquetes en los que el cliente intenta identificar una red wireless. Por lo que se puede obtener el nombre de redes que un cliente esta buscando e intenta verificar que se encuentran en su radio de acción.   \\ \hline
\end{tabular}
