...
\end{lstlisting}	
También, respecto a la interfaz, se ha añadido y adaptado la table principal donde se muestran las redes disponibles.
...
Este lenguaje ha sido utilizado, ademas de por sus multiples ventajas ya citadas, por el hallazgo de PixieScript, ya que al estar realizado en este lenguaje, su aprendizaje nos facilitaba la posibilidad de modificar y poder utilizarlo como plantilla.
