...
\end{lstlisting}
	...
	Esta sección se utilizará tanto para el protocolo WEP como para el WPA/WPA2.
		...
		\lstinputlisting[language=Python] {SUBSDOS.py.txt}
	
		\begin{itemize}
		
		\item SUBSDOS-Template.tex
		
		\lstinputlisting[language={[LaTeX]TeX}] {SUBSDOS-Template.tex.txt}
		
		\item INF-SUBSDOS.tex
		
		\lstinputlisting[language={[LaTeX]TeX}] {INF-SUBSDOS.tex.txt}
		\end{itemize}
	...
	Por último, se obtendrá toda la información necesaria a la hora de generar el informe automatizado, tras un ataque a una red con cifrado WEP. Los pasos que se han seguido son exactamente los mismos que las secciones anteriores.
		...
		\lstinputlisting[language=Python] {SUBSWEP1.py.txt}
		
		\begin{itemize}
		
		\item SUBSWEP1-Template.tex
		\lstinputlisting[language={[LaTeX]TeX}] {SUBSWEP1-Template.tex.txt}
...
CrearInformeWEP()
\lstinputlisting {CrearInformeWEP().txt}

\paragraph{Generar informe WPA.}

CrearInformeWPA()
\lstinputlisting {CrearInformeWPA().txt}
