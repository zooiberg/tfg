...
Como indica el gráfico anterior, a pesar de la disponibilidad de varios tipos de redes, la mayoría de las empresas optan por las redes inalámbricas. Y además, un 13\% de ellas no restringe el acceso.
...
El objetivo principal es realizar una pre-auditoria de caja negra automática, que sirva como argumento de venta de auditorias completas.
...
\begin{enumerate}
	...
	\item Creación de una aplicación de detección de dichas vulnerabilidades que funcione mediante un dispositivo de fácil uso y de bajo coste.
