...
Ésto se pensó, para fomentar y facilitar la venta de auditorias de seguridad. Por tanto, el dispositivo debe poder ejecutarse por un comercial sin conocimientos previos de informática, iniciando los ataque a la red inalámbrica, así se intentara concienciar a las empresas de la facilidad de encontrar información confidencial  y la posibilidad de ralentizar e incluso llegar a parar la producción de la mayoría de las empresas. Esto serviría como paso previo a una auditoria como tal, nunca como sustituto. 

Al referimos a una auditoria técnica de seguridad, se trata de un examen cuyo objetivo es evaluar la eficacia y eficiencia de los recursos informáticos y destacar posibles errores o fallos del sistema, pueden abarcar un gran numero de posibilidades (internas, externas, web\ldots). Centrándonos en las auditorias \emph{wireless}, se podrían tratar como auditorias internas o externas, dependiendo el nivel de información previa. 
En la actualidad  compartir datos en la red forma parte de nuestro día a día, y es una acción que realizamos desde nuestra infancia. Realmente, y a pesar de los numerosos ejemplos de la vulnerabilidad de estos datos, la sociedad aún no está lo suficientemente concienciada del fácil acceso a nuestra información. Por ello, no se le da la importancia necesaria a éste tema como debería, teniendo contratado a personal especializado en este ámbito y haciendo auditorias de seguridad de forma periódica.

Desde hace años se ha intentando concienciar a la población de éste serio problema que nos afecta a todos, desde los pequeños empresarios y la protección de bases de datos empresariales, hasta particulares y su información almacenada en sus dispositivos móviles. Nos encontramos en un momento en el que la información privada de las personas cada vez tiende a ser mas pública. 

Mi aplicación se centrara en las vulnerabilidades de las redes inalámbricas, estas redes están en continuo crecimiento, y disponen de algunas ventajas frente a las cableadas. No solo  por la comodidad en la instalación sino por la movilidad que te brinda. No todo son ventajas, ya que en las comunicaciones inalámbricas la información se ``propaga'' por el aire, siendo posible capturar o escuchar dicha información. Ninguna red inalámbrica es completamente segura ya que todos los mecanismos o protocolos tienen vulnerabilidades, pero se puede trabajar para conseguir niveles aceptables de seguridad. 
