...
\begin{center}
 ...
 \title{SEGURIDAD INFORMATICA EN REDES WIRELESS}
...
\doublespace\noindent \textsc{Seguridad y vulnerabilidad de redes inalámbricas}\\
...
\lettrine{E}{}ste proyecto consiste en la implementación de un dispositivo para generar posibles ataques básicos y conocidos a una red WiFi determinada, con el fin de generar un informe de manera automatizada con algunas de las posibles vulnerabilidades.

Se centrará en las vulnerabilidades de las redes inalámbricas, las cuales están en continuo crecimiento, y disponen de algunas ventajas frente a las cableadas. No solo por la comodidad en la instalación sino por la movilidad que te brinda. No todo son ventajas, ya que en las comunicaciones inalámbricas la información se ``propaga'' por el aire, siendo posible capturar o escuchar dicha información. Ninguna red inalámbrica es completamente segura ya que todos los mecanismos o protocolos tienen vulnerabilidades, pero se puede trabajar para conseguir niveles aceptables de seguridad.
...
\lettrine{D}{}esde el inicio del nuevo siglo, el uso de las tecnologías forma parte de nuestra actividad cotidiana, lo que implica que cada vez se tiende más, y con mayor frecuencia, a compartir en red todo tipo de datos.
Durante todos estos años de evolución tecnológica han aparecido cada vez más y novedosos métodos de intrusión, pérdida o robo de datos e información personal (spam, virus, troyanos, intrusiones en red, etc).
...
El objetivo principal será introducir a las empresas en la importancia de contar con una red inalámbrica segura, y la necesidad de realizar una pre-auditoria de caja negra automática, que detecte las vulnerabilidades de la red, y que sirva como argumento de venta de auditorias completas de forma periódica.
...
\begin{enumerate}
	\item Creación de una aplicación de detección de las vulnerabilidades de la red WiFi, que funcione mediante un dispositivo de fácil uso y de bajo coste. 	
	\item Dotación a dicha aplicación de una interfaz simple e intuitiva que facilite el desarrollo de una manera rápida, y pueda ser ejecutada por un comercial sin conocimientos informáticos previos. 
	\item Hacer que el dispositivo responsable de la ejecución de la aplicación sea portátil y de fácil movilidad.
	\item Recogida sistematizada de información de todos los datos del análisis realizados por el dispositivo, que se plasmara en un informe de manera automatizada. 
	\item Generación de un informe con posibles vulnerabilidades, según el estándar NIST SP 800-115\cite{SP}. Con un lenguaje sencillo y no demasiado técnico que permita una fácil comprensión.
...
\lettrine{D}{}esde que la tecnología forma parte de nuestra vida cotidiana, se encuentra cada vez más presente en las empresas, la pérdida o robo de información de datos electrónicos. Esto conlleva un importante agujero de seguridad, debido a una falta de previsión en la implantación de los métodos de seguridad.
...
A medida que aumentan la implementación de dispositivos informáticos individuales en las empresas como método de trabajo, es necesaria la conexión entre ellos para compartir los datos y poder llevar a cabo un trabajo colectivo. La interconexión de estos dispositivos se lleva a cabo mediante la creación de una red interna, pudiendo ser inalámbrica o cableada. Asegurar la red es de igual importancia que la protección de los dispositivos.
...
Como ha sido comentado anteriormente, igual de importante que la protección de los dispositivos, es la seguridad de las redes que lo conectan. También podemos extraer del informe de la INTECO, que frente al dato de casi el 100\% de los dispositivos se encuentran protegidos por algún posible método, por muy básico que sea, todavía un 13\% de las redes no cuentan con ningún tipo de protección. Tan importante es, el gasto de seguridad en la red, al mismo tiempo que su instalación, es decir desde un principio, como revisiones periódicas de la misma. Ya que la implantación de un cifrado o sistema de seguridad en un inicio, no garantiza una seguridad permanente. En la actualidad podemos elegir entre distintos protocolos de seguridad para las redes WiFi (WEP, WPA,WPA/WPA2), de los que se deben elegir WPA/WPA2 por los niveles de robustez en su cifrado. Hoy en día son usados indistintamente estos protocolos (27,4\%), debido a la falta de información de la diferencia de niveles de seguridad que aportan cada uno de ellos. 
...
\subsubsection{Protocolo WEP}
 WEP (Wired Equivalenet Privacy) fue el primer protocolo de cifrado que se implantó con el primer estándar IEEE 802.11. Es un protocolo que no ofrece mucha seguridad en una red inalámbrica, ya que esta seguridad está obsoleta y se conocen muchas maneras de descifrar el contenido de las tramas que van cifradas con WEP. Para entender bien estos términos debemos diferenciar bien entre autentificación, confidencialidad y integridad.
...
Para la automatización de dispositivos al tratarse de un proceso informático se compone de tres componentes importantes como hardware, software y los datos. 
...
La gran ventaja de este dispositivo radica en la gran comunidad que presentan, así dispone de mucha información y ayuda. En cuanto al sistema operativo, dispone de una gran utilidad ya que al instalarse en la tarjeta SD, se podrá contar con varios SO en distintas tarjetas. El más utilizado será ``Raspbian'' que se trata de un Debian(Linux) optimizado para este dispositivo.
...
En cuanto al software pueden se empleará una serie de programas informáticos, que harán posible la realización de este proyecto.
\paragraph{GNU/Linux}
...
Las mas utilizadas  en el proyecto son:
\begin{itemize}
...
A pesar del conocimiento de múltiples lenguajes de programación informática, se empleó este lenguaje porque es el lenguaje de programación utilizado en linux, y por tanto, nos brinda la oportunidad de aprender, esto fue uno de objetivos propuestos desde el inicio.
Este lenguaje interpretado cuenta con muchas ventajas  en cuanto; rapidez de ejecución, sintaxis clara, sencilla y su portabilidad puediéndose ejecutar en múltiples plataformas. Bash no solo reconoce comandos, nos ayuda agruparlos para realizar programas completos sobretodo para la automatización (como es el caso de esta aplicación). 

%%%%%%ANTECEDENTES INFORME ATOMATIZADO%%%%
\subsection{Sistemas de generación automática de informes}
Para la generación de un informe automatizado se debe contar con un dispositivo previamente programado, que realice algún tipo de acción que pueda recolectar la información para una posterior implementación en algún tipo de informe. Se pueden emplear la mayoría de los lenguajes de programación, pero \textit{Python} cuenta con varias bibliotecas de plantillas facilitando el trabajo.

\subsubsection{Python}
Se emplerá este lenguaje de programación como herramienta de enlace entre el informe, generado en \LaTeX{} y los \textit{Templates} empleando una librería de python:  \textit{jinja2}.
...
\subsubsection{\LaTeX{}}
\LaTeX{} es un sistema de preparación de documentos. Sirve para organizar y preparar artículos de revistas, libros, cartas, revistas, tesis y cualquier tipo de documento. Se desarrollo con el fin de facilitar y mejorar los textos científicos, sobre todo los matemáticos, y que estos se puedan utilizar entre distintas plataformas. Con el se desarrollo la memoria del proyecto y la generación del informe. 
...
\lettrine{E}{}n el proyecto, se utilizará la Raspberry Pi 3 Modelo B, que como se aprecia en la imagen anterior (Figura \ref{fig:Ras}), mejora las características de sus predecesoras con un nuevo procesador más rápido integrado para incrementar su velocidad. Cuenta también con funciones de WiFi y Bluetooth BLE para mejorar su funcionalidad y la capacidad de alimentar dispositivos más potentes mediante los puertos USB. Se optó por  este dispositivo por la facilidad que tiene a la hora de instalar un sistema operativo y la movilidad que te proporciona, pudiendo transportarlo sin ningún tipo de impedimento. Contando por supuesto con su gran comunidad y las ventajas de esto a la hora de buscar información y de solucionar los errores. 
\begin{figure}[H]
  \centering
...
\end{itemize}
 En cuanto a la conexión, Raspberry Pi no cuenta con ningún tipo de monitor o pantalla incorporado. Normalmente se conecta a alguna pantalla por la conexión HDMI o VGA que dispone. El motivo por el no se contemplo esta solución fue la falta de movilidad que mostraba. Por ello se emplea el propio móvil del comercial para lanzar el ataque. Por medio de una aplicación VNC (VIirtual Network Computing) que es un sistema gráfico para el intercambio de escritorio, controlando de forma remota el interfaz de escritorio de un dispositivo a otro.
 \begin{figure}[H]
  \centering
...
Se realizó una búsqueda completa en el mercado con varios posibles Chipset (Ralink RT3070, Ralink RT3572, Realtek 8187L, Ralink RT5370), empleando Atheros AR9271L \cite{alfa}, ya que no era excesivamente caro y proporcionaba una ganancia de 5 dbi y un rango de frecuencia de 2.412-2.483.
\begin{itemize}
...
\end{figure}
%%%INSTALACION%%%%%
\section{Instalación y configuración del sistema operativo de la Raspberry Pi}

Como ya se ha comentado con anterioridad, se empleará el sistema operativo Kali Linux, ya que es uno de los sistema operativo con herramientas de seguridad más completo que se puede encontrar y gratuito. Cuenta con la ventaja que también dispone de versiones para ARM.
...
Para las actualizaciones se emplearanlos siguientes comandos:
\begin{enumerate}
...
\subsubsection{Ataque en diccionario WPA/WPA2 }
...
\subsubsection{Extaer datos del punto de acceso.}
NOSE QUE PONER!!!!!!!!!!!!!!!!!!!!
 \begingroup{}
	\fontsize{7pt}{7pt}=\selectfont
	\verbatiminput {ExtraerDatosAp().txt}
\endgroup{}

\subsubsection{Ataque de diccionario WPA}
...
\section{Aplicación para el análisis de vulnerabilidad (Interfaz gráfica)}
La herramienta con la que se ha desarrollado la aplicación ha sido realizada en código bash linux. Utiliza la librería \textit{GTK dialog} para la gestión de pantalla, como interfaz gráfica. Pudiendo interactuar con diferentes botones que realizaran la tarea de análisis. 
...
Si se escoge ATACAR WEP se realizan se invocan las siguientes funciones:
\begin{itemize}
	\item AircrackWEP()
	\item DenegacionServicio()
	\item CrearInformeWEP()
\end{itemize}
Si se escoge ATACAR WPA se invocan las siguientes funciones:
\begin{itemize}
	\item ExtraerDatosAp()
	\item AircrackWPA()
	\item AnalizarPyrit()
	\item DenegacionServicio()
	\item CrearInformeWPA()
\end{itemize}
...
\lettrine{E}{}n la actualidad las redes inalámbricas están sustituyendo a los cables de red. Así la conexión no se limita a la longitud de un cable y se puede extender muchos metros alrededor del punto de acceso. 
