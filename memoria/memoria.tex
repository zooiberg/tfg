...
\lettrine{E}{}n cuanto a los objetivos del proyecto se destacará un objetivo principal, para entender el desarrollo de la aplicación al que se subordinaran una serie de objetivos secundarios.
\section{Objetivo general}
El objetivo principal será introducir a las empresas en la importancia de contar con un red inalambrica segura,realizando una pre-auditoria de caja negra automática, que sirva como argumento de venta de auditorias completas.
...
\begin{enumerate}
	\item Recogida sistematizada de información de todos los datos del análisis, que se plasmara en un informe de manera automatizada. 
	\item Generación de un informe con posibles vulnerabilidades, según el estándar NIST SP 800-115\cite{SP}. Como comentare mas adelante, este informe no va dirigido al personal de seguridad de la empresa. %Esta pensado exclusivamente para el responsable de la empresa, por lo tanto no tiene porque tener conocimientos previos informáticos. Se desarrollara con un lenguaje claro y no debe exceder de información muy técnica.
	\item Creación de una aplicación de detección de dichas vulnerabilidades que funcione mediante un dispositivo de fácil uso y de bajo coste. Empleando una Raspberry Pi, por 
...
\lettrine{E}n los métodos del proyecto, al tratarse de un proceso informático se compone de tres componentes importantes como hardware, software y los datos. 

\section{Detalles del Hardware}
Se ha intentado ir reduciendo al máximo el precioso y por ende todos los sistemas hardware para el desarrollo de mi aplicación, teniendo en cuenta que uno de los objetivos es que fuera una aplicación flexible y fácil de transportar.
